...
let funnyMessages = [
    ...
    "Did you forget to equip skill today? 🛡️🤔",
    "Tip: Dodging is allowed. 🕺",
    "Respawn and try again (maybe with both hands). 🤲",
    "Out-clicked, out-played, outta here. 🖱️🎮",
    "Next time, bring a helmet. And armor. And hope. 🪖🛡️🙏",
    "Imagine losing in Miniblox... tragic. 😬",
    "Your blocks? My blocks now. 🧱👉🧱",
    "Are you sure you're not an bot? 🤖",
    "Pro tip: The void is not a shortcut. 🕳️",
    "Is your keyboard upside down? ⌨️🔄",
    "That scoreboard doesn't lie. 📊",
    "Did you lag, or just freeze from fear? 🥶",
    "Was that a speedrun to the void? 🏃‍♂️🕳️",
    ...
    "You respawn more than you blink. 👁️",
    ...
    "The only thing lower than your HP was your chance to win. 🩸⬇️",
    "If you see this, you lost the 50/50. Badly. 🎲",
    "That performance was sponsored by gravity. 🪂",
    "Your only kill streak is in the practice lobby. 🏟️",
    "You bring a whole new meaning to 'easy win.' 😎",
    "That was faster than a Miniblox queue skip. ⏩",
    "You just gave me free stats. 📈",
    "Did you drop your keyboard? Because your plays are a mess. ⌨️😵",
    "I’ve seen bots with better aim. 🤖🎯",
    "Are you playing with your monitor off? 🖥️🙈",
    "You just got outplayed by someone eating snacks IRL. 🍪😋",
    "Did your mouse disconnect? 🖱️🔌",
    "If you’re reading this, you just lost a 1v1. 1️⃣🆚1️⃣",
    "Not even lag could save you. 🌐",
    "Your respawn button must be tired. 🔄",
    "You fight like a Minecraft villager. 👨‍🌾",
    "Maybe try using both hands next time. ✋🤚",
    "Spectator mode looks good on you. 👀",
    "I hope you brought a map, because you’re lost. 🗺️",
    "Knocked out like my WiFi on a stormy day. 🌩️",
    "That combo was sponsored by gravity. 🪂💥",
    "I’d say GG, but that wasn’t even close. 😅",
    "Blink if you need help. 👁️👁️",
    "You just got styled on. 💅",
    "Don’t worry, practice makes... well, you tried. 🤷",
    // More from popular clients & meme culture
    "That was a free kill, thanks! 🙏",
    "You just got clipped for the montage! 🎬",
    "Your defense was like paper. 📄",
    "Nice try, maybe next queue. ➡️",
    "Sent you flying like a fireball. 🔥🪁",
    "You look like you just installed the game. 🆕",
    "Watch out, you're on my highlight reel now. 📹",
    "Imagine losing to autoqueue lol. 🤖😂",
    "Did you even touch your keyboard? ⌨️❓",
    "You just got block clutched... by the void. 🕳️🧱",
    "That was a certified skill issue. 📜",
    "You got 360'd and still lost. 🔄",
    "Void called, said thanks for the donation. 🕳️🎁",
    "Bro, you just gave me free loot. 💰",
    "Try not to fall off next time. 🚶‍♂️🕳️",
    "Minimum effort, maximum result. 💤🏆",
    "You play like it's your first day. 📅",
    "I almost felt bad… almost. 🙃",
    "Did you lag or just freeze? ❄️",
    "Spectator mode activated! 👓",
    "If you see this, you just got farmed. 🚜",
    "That wasn't even worth the XP. 🧸",
    "You just helped my win streak. 🔥",
    "Outplayed and outclassed. 🏅",
    "That was a speedrun back to the lobby. 🏃‍♂️🚪",
    "Try using both hands next time. 👐",
    "Bowspammed and still lost. 🏹",
    "Void: 1, You: 0. 🕳️",
    "I'm not even trying, fr. 😴",
    "You're making this too easy. 😌",
    "That was a warmup for me. 🥱",
    "Get good, get Miniblox. 💪",
    "AFK players put up more of a fight. 💤",
    "Respawn and repeat. 🔄",
    "Outplayed while eating chips. 🍟",
    "That was a paid actor, right? 🎭",
    "My grandma clicks faster than that. 👵🖱️",
    "You got combo'd into another game. 🎮",
    "Bro, the void loves you. 🕳️❤️",
    "That was a controller disconnect moment. 🎮🔌",
    "You got sent to the shadow realm. 👻",
    "Try again after the anticheat update (never). 🔄",
